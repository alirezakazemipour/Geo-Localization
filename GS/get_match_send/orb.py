...
I1 = cv2.imread('/home/alireza/Documents/cv-lab12/obj3.jpg')
G1 = cv2.cvtColor(I1,cv2.COLOR_BGR2GRAY)

I2 = cv2.imread('/home/alireza/Documents/cv-lab12/scene.jpg')
G2 = cv2.cvtColor(I2,cv2.COLOR_BGR2GRAY)

orb = cv2.ORB_create(nfeatures=1500) # opencv 3
# use "sift = cv2.SIFT()" if the above fails

# detect keypoints and compute their disriptor vectors
keypoints1, desc1 = orb.detectAndCompute(G1, None); # opencv 3
keypoints2, desc2 = orb.detectAndCompute(G2, None); # opencv 3
