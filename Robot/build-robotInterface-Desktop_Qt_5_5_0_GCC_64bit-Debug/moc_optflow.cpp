...
#include "../robotInterface/optflow.h"
...
struct qt_meta_stringdata_OptFlow_t {
    QByteArrayData data[6];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OptFlow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OptFlow_t qt_meta_stringdata_OptFlow = {
    {
QT_MOC_LITERAL(0, 0, 7), // "OptFlow"
QT_MOC_LITERAL(1, 8, 6), // "optSig"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 10), // "timerEvent"
QT_MOC_LITERAL(4, 27, 7), // "cv::Mat"
QT_MOC_LITERAL(5, 35, 9) // "raw_image"

    },
    "OptFlow\0optSig\0\0timerEvent\0cv::Mat\0"
    "raw_image"
};
...
void OptFlow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (OptFlow::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptFlow::optSig)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject OptFlow::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OptFlow.data,
      qt_meta_data_OptFlow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OptFlow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OptFlow.stringdata0))
