...
#include "../robotInterface/sendimg.h"
...
QT_MOC_LITERAL(3, 14, 3), // "Mat"
QT_MOC_LITERAL(4, 18, 1) // "b"

    },
    "sendImg\0send\0\0Mat\0b"
};
...
void sendImg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        sendImg *_t = static_cast<sendImg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send((*reinterpret_cast< Mat(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject sendImg::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_sendImg.data,
      qt_meta_data_sendImg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sendImg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sendImg.stringdata0))
        return static_cast<void*>(const_cast< sendImg*>(this));
